from src.etl.library_pandas.extract_functions import PandasCSVExtractor, PandasJSONExtractor, PandasHDF5Extractor, PandasParquetExtractor
from src.etl.library_pandas.pandas_transformation_strategy import PandasTransformationStrategyFactory
from src.etl.library_pandas.load_functions import PandasFileLoader
from src.etl.utils.database.database_extractor_factory import DatabaseExtractorFactory
from src.etl.utils.database.database_loader_factory import DatabaseLoaderFactory
...
class PandasETLFactory:
    ...
    def get_extractor(self, source_type, **kwargs):
        if source_type == "csv":
            ...
            return PandasParquetExtractor(kwargs['file_path'])
